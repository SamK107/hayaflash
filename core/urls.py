...
from flash_sales.public_views import (
    public_flash_sale_calendar,
    public_flash_sale_detail,
)
...
urlpatterns = [
    ...
    path(
        "ventes/<slug:slug>/", public_flash_sale_detail, name="flash_sale_public_detail"
    ),
