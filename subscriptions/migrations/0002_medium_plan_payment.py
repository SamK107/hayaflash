    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                db_index=True, default="free", max_length=20, verbose_name="Plan",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("plan", models.CharField(choices=[("free", "Gratuit"), ("medium", "Medium"), ("pro", "Pro")], max_length=20)),
                ("provider", models.CharField(choices=[("orange", "Orange Money"), ("moov", "Moov Money"), ("wave", "Wave")], max_length=20)),
                ...
                ("status", models.CharField(
                    choices=[("pending","En attente"),("success","Succes"),("failed","Echec"),("cancelled","Annule"),("expired","Expire")],
            ...
            options={"verbose_name": "Paiement abonnement", "verbose_name_plural": "Paiements abonnement", "ordering": ["-created_at"]},
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="subscriptionpayment",
            index=models.Index(fields=["seller", "status"], name="sub_pay_seller_status_idx"),
        ),
    ]
